...
for i = 1:1%length(files)
    ...
    data_now = readtable(filename,...
                    'Sheet',sheetname,'readVariableNames',0); % load the data
    % **PNE
    data1.I = data_now.Var7;
    data1.V= data_now.Var6;
    data1.t2 = data_now.Var5; % experiment time, format in duration
    data1.t1 = data_now.Var4; % step time, format in duration
    data1.cycle = zeros(size(data1.t1)); 
    data1.T = data_now.Var11;
